import {serviceLead} from './utils/rolesData'
              ...
              <div className='row'>
                <div className='col-12'>
                  ...
                  <div className='row' id='sl'>
                    ...
                    <p>{serviceLead.paragraph}</p>
                    <div className='separator-short'></div>
                    <div>
                      <ol style={{paddingLeft: '50px'}}>
                        {serviceLead.dataLists.map((t, index) => {
                          return (
                            <li>
              ...
              <div className='row'>
                <div className='col-12'>
                  <div className='row' id='sl'>
                    <h2>
                      <div>
                        <b>My one week as a Service Lead</b>
                      </div>
                    </h2>
                    <h2>
                      <span>
