import {qa} from './utils/rolesData'
import {qa_img} from '../../../../setup/appConstants'
              ...
              <div className='row'>
                <div className='col-12'>
                  <div className='row' id='qa'>
                    <h2>
                      <div>
                        <b>My one week as a QA</b>
                      </div>
                    </h2>
                    <h2>
                      <span>
                        <img alt='' src={qa_img} width='100%' style={{marginRight: '10px'}} />
                      </span>
                    </h2>
                  </div>
                </div>
